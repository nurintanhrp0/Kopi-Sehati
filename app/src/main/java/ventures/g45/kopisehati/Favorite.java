...
import ventures.g45.kopisehati.adapter.adapter_favorite;
...
public class Favorite extends AppCompatActivity {
    ...
    LinearLayout blockInfo, blockPromo;
    ListView listView;
    Typeface MontserratRegular;
    String defaultUrl, urlFavorite, noHp, dataUrl;
    Integer id_outlet;
    ...
    float factor;
    private List<modal_favorite> list;
    adapter_favorite adapter;
    AlertDialog.Builder dialog;
    LayoutInflater inflater;
    View dialogView;
    AlertDialog alertDialog;
    TextView txtTitle, namaProduk, detailProduk, txtTotall, txtSize, totall, increment, decrement, display;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlFavorite = defaultUrl + "getFavorite.html";
        ...
        txtHeader = findViewById(R.id.txtTitle);
        txtHeader.setTypeface(MontserratRegular);
        ...
        adapter = new adapter_favorite(Favorite.this, R.layout.cv_favorite, list);
    ...
    private class GetFavorite extends AsyncTask<String, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            JSONObject jsonObject = jsonParser.makeHttpRequest(urlFavorite, "POST", params);
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Favorite.this);
                        ...
                        if (result.has("data")){
                            ...
                            if (daftarOrder.length() > 0) {
                                ...
                                for (int j = 0; j < daftarOrder.length(); j++) {
                                    ...
                                    modal_favorite modalOrders = new modal_favorite();
                                    modalOrders.setThumbnail(daftar.getString("thumbnail"));
                                    modalOrders.setNama(daftar.getString("nama"));
                            ...
                            if (kategoriMenu.length() > 0) {
                                for (int i = 0; i < kategoriMenu.length(); i++) {
                                    ...
                                    LinearLayout kategori = new LinearLayout(Favorite.this);
                                    kategori.setPadding((int) (0 * factor), (int) (0 * factor), (int) (0 * factor), (int) (10 * factor));
                                    kategori.setBackground(getDrawable(R.drawable.radius_corners));kategori.setOrientation(LinearLayout.VERTICAL);
                                    ImageView thumbnail = new ImageView(Favorite.this);
                                    ...
                                    TextView nama = new TextView(Favorite.this);
                                    nama.setTextSize(16);
                                    ...
                                    TextView harga = new TextView(Favorite.this);
    ...
    public void showDetailMenu(){
        ...
        dialog = new AlertDialog.Builder(Favorite.this, R.style.Theme_AppCompat_Light_NoActionBar_FullScreen);
                    ...
                    if (result.getInt("error") == 1){
                        ...
                        if (size.length() > 0) {
                            for (int i = 0; i < size.length(); i++) {
                                ...
                                final LinearLayout daftar = new LinearLayout(Favorite.this);
                                ...
                                final TextView nama = new TextView(Favorite.this);
                                nama.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
                                nama.setLayoutParams(layoutNama);
                                nama.setTypeface(MontserratRegular);
                    ...
                    if (jsonObject.getInt("error") == 1){
                        ...
                        if (jsonObject.has(jsonObject.getString("cek"))) {
                            if (jsonObject.getInt("cek") == 2) {
                                AlertDialog.Builder builder1 = new AlertDialog.Builder(Favorite.this);
