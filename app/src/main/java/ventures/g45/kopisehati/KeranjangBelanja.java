...
public class KeranjangBelanja extends AppCompatActivity {
  ...
  TextView txtTitle, txtPromo, txtSeeAll;
  ImageView icBack;
  Typeface MontserratRegular;
  String noHp, dataUrl, defaultUrl, urlGetProduk;
  Integer id_outlet;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    urlGetProduk= defaultUrl + "getinbox.html";
    ...
    txtSeeAll.setTypeface(MontserratRegular);
  ...
  private class GetProduk extends AsyncTask<String, Void, JSONObject> {
          ...
          if (result.getInt("error") == 1){
            ...
            if (kategoriMenu.length() > 0) {
              for (int i = 0; i < kategoriMenu.length(); i++) {
                ...
                LinearLayout kategori = new LinearLayout(KeranjangBelanja.this);
                ...
                ImageView thumbnail = new ImageView(KeranjangBelanja.this);
                ...
                TextView nama = new TextView(KeranjangBelanja.this);
                nama.setTextSize(16);
                ...
                TextView harga = new TextView(KeranjangBelanja.this);
  ...
  public void showDetailMenu(){
    ...
    dialog = new AlertDialog.Builder(KeranjangBelanja.this, R.style.Theme_AppCompat_Light_NoActionBar_FullScreen);
  ...
  private class GetDetailMenu extends AsyncTask<String, Void, JSONObject> {
    ...
    protected void onPreExecute() {
      super.onPreExecute();
      pDialog = new ProgressDialog(KeranjangBelanja.this);
          ...
          if (result.getInt("error") == 1){
            ...
            if (size.length() > 0) {
              for (int i = 0; i < size.length(); i++) {
                ...
                final LinearLayout daftar = new LinearLayout(KeranjangBelanja.this);
                ...
                final TextView nama = new TextView(KeranjangBelanja.this);
                nama.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
                nama.setLayoutParams(layoutNama);
                nama.setTypeface(MontserratRegular);
          ...
          if (jsonObject.getInt("error") == 1){
            ...
            if (jsonObject.has(jsonObject.getString("cek"))) {
              if (jsonObject.getInt("cek") == 2) {
                AlertDialog.Builder builder1 = new AlertDialog.Builder(KeranjangBelanja.this);
